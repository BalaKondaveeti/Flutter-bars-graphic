...
class _AnimatingPercentageShowerState extends State<AnimatingPercentageShower> {
  ...
  @override
  void initState() {
    int lastFullHeightTile = (widget.percentage ~/ (100/28));
    print(lastFullHeightTile);
    height = (widget.percentage / (100/28)) - lastFullHeightTile;
    print(height);
  ...
  Widget build(BuildContext context) {
    ...
    return ClipRRect(
      ...
      child: Column(
        ...
        children: [
          for(int l=0,i=1;l<7;++l) [
            for(int j=0; j<4;++j,++i) i
          ]         
        ]
